...
namespace SimpleMenu
{
	...
	inline void smAlert(const char* title, const char* text){}
	inline void smOpenWaitDialog(const char* title, const char* text, smUpdateCallback callback, void* context) {};
}